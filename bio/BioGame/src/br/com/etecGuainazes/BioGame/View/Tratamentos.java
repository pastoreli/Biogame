		...
		try {
			...
			if(rs.next()){
				...
				if(rs.getInt("nivel1")==1){
					...
					textoM = new JLabel("<html><p>Não deixe água parada, retire água das garrafas e as vire para baixo. Tampe sua caixa d'água, mantenha os pratos de vasos de plantas com areia, mantenha seu jardim sempre limpo e livre de água parada, não deixe água parada dentro de pneus velhos e mantenha sua calha limpa.</p></html>");
		...
		try {
			...
			if(rs.next()){
				...
				if(rs.getInt("nivel2")==1){
					...
					textoD = new JLabel("<html><p>Não há tratamento específico, apenas algumas formas de aliviar os sintomas. Deve-se ingerir muito líquido para manter a hidratação, sendo a água de coco uma ótima opção.Para combater a febre alta e as dores, recomenda-se o uso de dipirona e paracetamol, jamais usar antitérmicos que contenham ácido acetilsalicílico, como AAS e Melhoral, que podem causar sangramentos, também não se deve fazer o uso de anti-inflamatórios por causa de seu potencial hemorrágico.</p></html>");
