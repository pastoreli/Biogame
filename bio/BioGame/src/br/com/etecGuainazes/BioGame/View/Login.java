...
public class Login extends JPanel {
	...
	static public boolean iniciado = false;
	
	//popUp
	
	static public JPanel caixa;
	
	JLabel erro, logoCentro;

	static public JLabel desc;
	...
	public Login(){
		...
		cabecalho.setForeground(new Color(66,170,33));
		cabecalho.setFont(new Font("Century Gothic",  Font. PLAIN,  35));
		...
		texto.setFont(new Font("Century Gothic",  Font. PLAIN,  40));
		texto.setHorizontalAlignment(SwingConstants.CENTER);
		
		txtUser = new JTextField("Nome de usuário");
		...
		txtUser.addFocusListener(new FocusListener() {  
			...
			public void focusGained(FocusEvent arg0) {
				...
				if(txtUser.getText().equals("Nome de usuário")){
					
					txtUser.setText("");
					
				}
	
				faixaUser.setBackground(new Color(66,170,33));
				txtUser.setForeground(new Color(66,170,33));
...
//		});
		...
		txtSenha.addFocusListener(new FocusListener() {  
			...
			public void focusGained(FocusEvent arg0) {
				...
				faixaSenha.setBackground(new Color(66,170,33));
				txtSenha.setForeground(new Color(66,170,33));
		...
		logar.setBackground(new Color(66,170,33));
		...
		logar.addMouseListener(new MouseAdapter() {
			 ...
			 public void mouseEntered(MouseEvent e) {
				 ...
				 logar.setBackground(new Color(49,127,25));
		...
		logar.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(iniciado == false){
					...
					if(txtUser.getForeground().equals(new Color(200,200,200)) && txtSenha.getForeground().equals(new Color(200,200,200))){
		...
		textoCad.setFont(new Font("Century Gothic",  Font. PLAIN,  40));
		textoCad.setHorizontalAlignment(SwingConstants.CENTER);
		
		txtUserCad = new JTextField("Nome de usuário");
		...
		txtUserCad.addFocusListener(new FocusListener() {  
			...
			public void focusGained(FocusEvent arg0) {
				...
				if(txtUserCad.getText().equals("Nome de usuário")){
					
					txtUserCad.setText("");
					
				}
	
				faixaUserCad.setBackground(new Color(66,170,33));
				txtUserCad.setForeground(new Color(66,170,33));
			...
			public void focusLost(FocusEvent arg0) {
				...
				if(txtUserCad.getText().equals("")){
					...
					txtUserCad.setText("Nome de usuário");
					txtUserCad.setForeground(new Color(205,205,205));
		...
		txtSenhaCad.addFocusListener(new FocusListener() {  
			...
			public void focusGained(FocusEvent arg0) {
				...
				faixaSenhaCad.setBackground(new Color(66,170,33));
				txtSenhaCad.setForeground(new Color(66,170,33));
		...
		txtMail.addFocusListener(new FocusListener() {  
			...
			public void focusGained(FocusEvent arg0) {
				...
				faixaMail.setBackground(new Color(66,170,33));
				txtMail.setForeground(new Color(66,170,33));
		...
		cadastrar.setBackground(new Color(66,170,33));
		...
		cadastrar.addMouseListener(new MouseAdapter() {
			 ...
			 public void mouseEntered(MouseEvent e) {
				 ...
				 cadastrar.setBackground(new Color(49,127,25));
		...
		cadastrar.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(iniciado == false){
					...
					if(txtUserCad.getForeground().equals(new Color(200,200,200)) && txtSenhaCad.getForeground().equals(new Color(200,200,200)) && txtMail.getText() != "Email" && txtMail.getForeground().equals(new Color(200,200,200))){
...
//		public void setComponentZOrder(caixa comp,int 200);
		...
		caixa.setBounds(0,h,w,200);
		caixa.setBackground(new Color(66,170,33));
		caixa.setOpaque(true);
		
		erro = new JLabel("Erro");
		erro.setBounds(0,20,w,40);
		erro.setForeground(new Color(255,255,255));
		erro.setFont(new Font("Century Gothic",  Font. PLAIN,  40));
		erro.setHorizontalAlignment(SwingConstants.CENTER);
		
		desc = new JLabel("Nome de usuário ou senha invalidos");
		desc.setBounds(0,80,w,30);
		desc.setForeground(new Color(255,255,255));
		desc.setFont(new Font("Century Gothic",  Font. PLAIN,  26));
		desc.setHorizontalAlignment(SwingConstants.CENTER);
		
		
		ImageIcon logo = new ImageIcon("img/logoLogin.png");
		logoCentro = new JLabel();
		logoCentro.setBounds((w/2)-50, (h/2)-50, 100, 100);
		logoCentro.setIcon(new ImageIcon(logo.getImage().getScaledInstance(logoCentro.getWidth(),logoCentro.getHeight(), Image.SCALE_DEFAULT)));
		this.add(logoCentro);
