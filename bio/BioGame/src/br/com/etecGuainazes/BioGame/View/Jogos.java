...
public class Jogos extends JPanel{
	...
	public Jogos(){
		...
		voltar.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(iniciado == false){
					...
					ControladorFrame.cor1 = new Color(230,230,230);
					ControladorFrame.cor2 = new Color(210,210,210);
					ControladorFrame.fechar.setBackground(new Color(230,230,230));
					ControladorFrame.minimizar.setBackground(new Color(230,230,230));
		...
		lblTempo.setBounds((this.getWidth()/2)-50,this.getHeight()-40,100,38);
		...
		relogio.setBounds((this.getWidth()/2)+50,this.getHeight()-31,25,25);
		...
		borda.setBounds(0,this.getHeight()-40,w+2,2);
		...
		oculta.setBounds(0,this.getHeight()-38,w+2,38);
